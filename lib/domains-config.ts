...
export const domains: DomainConfig[] = [
  ...
  // ==================== 7. Romantic Date VADODARA ====================
  {
    ...
    keywords: [
      ...
      { slug: "romantic-romantic-date-surat", title: "Romantic Date", h1: "Romantic Date in Surat", metaTitle: "Romantic Date Surat | Perfect Setting", metaDescription: "Plan a romantic date in Surat with beautiful setup and city views." },

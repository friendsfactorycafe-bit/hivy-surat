...
export default function FFCMenuPage() {
  const menuFaqs = [
    ...
    { question: "What food is included in each celebration package?", answer: "Every package includes a full three-course meal: starters (cheese fondue, paneer tortilla), main course (peri peri fries, mac & cheese, tangy loaf with cheesy garlic sauce), and dessert (chocolate brownie). Plus welcome drinks and signature mocktails." },
    ...
    { question: "How is the food served during the 3-hour celebration?", answer: "Food is served in courses timed to match the celebration arc: welcome drinks and light starters in the first 30 minutes, main course during the middle section, and desserts with cake-cutting towards the final hour. Timing is flexible to your pace." },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              ...
              <p>
                The beverages are served at two points during the evening: once with the starters as a welcome drink, and again during the dessert phase as a celebratory toast. The timing matters because a raised glass paired with fairy-light reflections and your partner's smile creates one of the most photographed moments of any HIVY celebration.
              </p>
